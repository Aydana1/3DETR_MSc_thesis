...
class Pointnet2Backbone(nn.Module):
    ...
    def __init__(self, input_feature_dim=0, width=1, depth=2):
        ...
        self.fp2 = PointnetFPModule(mlp=[256 * width + 256 * width, 256 * width, 256 * width])
        self.fp3 = PointnetFPModule(mlp=[128 * width + 256 * width, 128 * width, 256]) # not 288 
    ...
    def forward(self, pointcloud: torch.cuda.FloatTensor, end_points=None):
        ...
        end_points['fp2_xyz'] = end_points['sa1_xyz']  #end_points['sa2_xyz'] 
