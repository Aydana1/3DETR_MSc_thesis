        ...
        if split_set == "all":
            ...
            with open(split_filenames, "r") as f:
                ...
                if split_set == 'train':
                        ...
                        print("Original TRAIN SET: ", num_scans)
                        # self.scan_names = self.scan_names[:int(len(self.scan_names) * 0.1)] # 120
                        # self.scan_names = self.scan_names[:int(len(self.scan_names) * 0.25)] # 300
                        # self.scan_names = self.scan_names[:int(len(self.scan_names) * 0.5)] # 600
                        # self.scan_names = self.scan_names[:int(len(self.scan_names) * 0.75)] # 900
                        print("NEW TRAIN SET: ", len(self.scan_names))
